...
import { cardProjects } from "@/data/project"
...
export default function CaroussselHomeBento() {
  ...
  const project:CardProjectInfo[] = cardProjects;

  const projetNeeded = ["wiki-app","loarwenn","sudoku"]
  ...
  return (
    ...
    >
      {/* Images */}
      {project
      .filter(project =>  projetNeeded.includes(project.slug))
      
      .map((project, i) => (
        <a href={project.link??"#"} key={project.slug}>
